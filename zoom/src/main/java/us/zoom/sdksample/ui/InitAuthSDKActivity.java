...
public class InitAuthSDKActivity extends Activity implements InitAuthSDKCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        zoomMeetingID = getIntent().getStringExtra("ZOOM_MEETING_ID");
        zoomMeetingPWD = getIntent().getStringExtra("ZOOM_MEETING_PWD");
        ...
        InitAuthSDKHelper.getInstance().initSDK(this, this, jwt);
...
//            showProgressPanel(false);
    ...
    private void joinMeeting() {
        ...
        params.password = zoomMeetingPWD;
        params.join_token = "";
        ZoomSDK.getInstance().getMeetingService().joinMeetingWithParams(this, params, ZoomMeetingUISettingHelper.getJoinMeetingOptions());
    }
