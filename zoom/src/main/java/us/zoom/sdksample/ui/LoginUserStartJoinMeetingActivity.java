...
public class LoginUserStartJoinMeetingActivity extends Activity implements AuthConstants, MeetingServiceListener, ZoomSDKAuthenticationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        meetingTokenEdit= (EditText) findViewById(R.id.edit_join_meeting_token);
    ...
    public void onClickBtnJoinMeeting(View view) {
        ...
        String zoomMeetingToken = meetingTokenEdit.getText().toString().trim();
        ...
        if (vanityId.length() != 0) {
            ret = JoinMeetingHelper.getInstance().joinMeetingWithVanityId(this, vanityId, meetingPassword,zoomMeetingToken);
        } else {
            ret = JoinMeetingHelper.getInstance().joinMeetingWithNumber(this, meetingNo, meetingPassword,zoomMeetingToken);
        }
